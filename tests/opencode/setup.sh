...
mkdir -p "$HOME/.config/opencode/autonome"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/autonome/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/autonome/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/autonome/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/autonome.js" "$HOME/.config/opencode/autonome/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/autonome/.opencode/plugin/autonome.js" \
       "$HOME/.config/opencode/plugin/autonome.js"
...
echo "Plugin installed to: $HOME/.config/opencode/autonome/.opencode/plugin/autonome.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/autonome.js"

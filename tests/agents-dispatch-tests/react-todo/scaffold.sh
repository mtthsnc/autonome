#!/bin/bash
# Scaffold the React Todo test project
...
echo "Scaffolded React Todo project at: $TARGET_DIR"
echo ""
echo "To run the test:"
echo "  claude -p \"Execute this plan using autonome:use-subagents-dispatch. Plan: $TARGET_DIR/plan.md\" --plugin-dir /path/to/autonome"

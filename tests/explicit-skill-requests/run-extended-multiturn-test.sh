...
TIMESTAMP=$(date +%s)
OUTPUT_DIR="/tmp/autonome-tests/${TIMESTAMP}/explicit-skill-requests/extended-multiturn"
mkdir -p "$OUTPUT_DIR"
...
echo ">>> Turn 1: Brainstorm request..."
...
echo ">>> Turn 5: Requesting use-subagents-dispatch..."
